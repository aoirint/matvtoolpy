...
def handle_find_image_cli(args: Namespace) -> None:
    ss: str | None = args.ss
    to: str | None = args.to
...
def add_arguments_find_image_cli(parser: ArgumentParser) -> None:
    parser.add_argument(
        "-ss",
        type=str,
        required=False,
